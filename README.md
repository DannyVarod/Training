...
1. [Database and Messaging Technology Types](./database-types.md)
    1. [Relational databases](./relational-dbs.md)
    2. [Document databases](./document-dbs.md)
    3. [Key-Value databases](./key-value-dbs.md)
    4. [Wide-column databases](./wide-column-dbs.md)
    5. [Columnar databases](./columnar-dbs.md)
...
2. [Data modelling and database types](./data-modelling-db-types.md)
    ...
    3. [Data modelling and document databases](./data-modelling-document-dbs.md)
    4. [Data modelling and key-value databases](./data-modelling-key-values-dbs.md)
...
3. [Concurrency and databases](./concurrency-and-dbs.md)
    1. [Concurrency and relational databases](./concurrency-relational-dbs.md)
    2. [Concurrency and document databases](./concurrency-document-dbs.md)
    3. [Concurrency and key-value databases](./concurrency-key-value-dbs.md)
